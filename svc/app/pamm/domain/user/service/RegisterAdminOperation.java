...
public class RegisterAdminOperation {
    private static final Logger.ALogger LOG = Logger.of(RegisterAdminOperation.class);
    ...
    public ServiceResult execute(final JsonNode jsonRequest) {
        ...
        if (!whiteListRepository.emailWhiteListed(userEmail, Role.ADMIN)) {
